...
def get_current_models(models_dir):
    ...
    items_to_remove = ['MODELS.txt', 'public_models.json']
...
if __name__ == '__main__':
    ...
    with gr.Blocks(title='BFRVCWebUI', theme="Thatguy099/Sonix") as app:

        gr.Label('BF RVC WebUI created with ❤️', show_label=False)
        ...
        with gr.Tab("Generate"):
            ...
            with gr.Accordion('Voice conversion options', open=False):
                with gr.Row():
                    ...
                    with gr.Column():
                        f0_method = gr.Dropdown(['rmvpe', 'fcpe', 'crepe', 'crepe-tiny'], value='rmvpe', label='Pitch detection algorithm', info='Best option is rmvpe')
            ...
            clear_btn.click(lambda: [0, 0, 0, 0, 0.5, 3, 0.25, 0.33, 'rmvpe', 128, 0, 0.15, 0.2, 0.8, 0.7, 'mp3', None],
                            outputs=[pitch, main_gain, backup_gain, inst_gain, index_rate, filter_radius, rms_mix_rate,
                                     protect, f0_method, crepe_hop_length, reverb_rm_size, reverb_wet,
